...
public class UserInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h3> Reading QuerySting data using 'String getParameter(String name)' method :</h3>");
		out.println("<div>");
		...
		out.println("<h3> Reading QuerySting data using 'Map getParameterMap()' method :</h3>");
		out.println("<div>");
